...
const withSerwist = withSerwistInit({
  ...
  additionalPrecacheEntries: [
    ...
    { url: '/entrada', revision: null },
    { url: '/entrada/login', revision: null },
    { url: '/entrada/ventas', revision: null },
    { url: '/entrada/cierre', revision: null },
    { url: '/entrada/config', revision: null },
    { url: '/manifest-buffet.webmanifest', revision: null },
    { url: '/manifest-entrada.webmanifest', revision: null },
